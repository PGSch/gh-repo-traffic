...
class TestGHRepoTraffic(unittest.TestCase):
    ...
    @patch.dict(os.environ, {"GITHUB_TOKEN": "fake_token", "GITHUB_USERNAME": "fake_user"})
    ...
    def test_fetch_repositories(self, mock_get):
        ...
        mock_get.assert_called_once_with("https://api.github.com/users/fake_user/repos", headers={"Authorization": "token fake_token"})
